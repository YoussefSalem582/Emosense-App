...
class VoiceAnalysisRepositoryImpl implements VoiceAnalysisRepository {
  @override
  Future<VoiceAnalysisResult> analyzeVoice({
    ...
    return _createAnalysisResult(filePath, analysisType);
  }
  ...
  Future<VoiceAnalysisResult> analyzeVoiceDemo({
    ...
    return _createDemoResult(analysisType);
  }
